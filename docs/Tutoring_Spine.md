...
Prepared 14 September 2026 against build v2.36; updated 16 September 2026 for v2.45.
...
| Mathematics | MATH 1170 Calculus for Business and Economics | `Foundation` | Precalculus | 3 | 14 | 66 |
...
| Foundation | **Calculus for Business and Economics** ✅ **built through chapter 12, v2.45** — scope fixed by the TRU outline (read 16 Sep 2026): 10.1–10.4, 11.1–11.5, 12.1/12.2/12.4/12.5/12.7, 13.1–13.6, 17.1–17.5; chapters 14–16 are not in MATH 1170 | Precalculus | Limits and continuity; Differentiation; Additional differentiation topics; *to come:* Curve sketching (ch 13); Multivariable calculus (ch 17) |
